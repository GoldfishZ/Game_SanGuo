...
from src.game_data.generals_gallery import show_generals_gallery, interactive_gallery
...
def show_game_info():
    ...
    print("- 三国武将卡牌对战")
    print("- 武力/智力属性系统")
    print("- 七大武将属性: 勇猛、魅力、募兵、防栅、连计、复活、伏兵")
    print("- 主动/被动技能系统")
    ...
    print("- 技能需要消耗团队士气")
    print("- 被动技能自动触发")
    print("- 勇猛/魅力通过掷骰猜奇偶判定")
    print("- 防栅可抵挡普攻并重建，伏兵可替位承伤")
...
def main():
    """主函数"""
    import src.game_data.generals_config  # 确保初始化
